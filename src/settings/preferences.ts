...
const translations: Record<string, Record<TranslationKey, string>> = {
  "zh-CN": {
    ...
    "arrangements.add": "新建安排",
    "arrangements.drawerState": "内测",
    "arrangements.drawerPreview": "医院、早餐、资料整理",
    "arrangements.statPending": "待安排",
    "arrangements.statToday": "今天",
    "arrangements.statTimed": "有时间",
    "arrangements.statLater": "以后再说",
    "arrangements.openPendingItems": "查看待安排事项",
    "arrangements.openTimedItems": "查看有时间事项",
    "arrangements.openLaterItems": "查看以后再说事项",
    "arrangements.closeStatItems": "关闭事项列表",
    "arrangements.laterSheetTitle": "以后再说",
    "arrangements.pendingSheetEmpty": "这里还没有待安排事项",
    "arrangements.timedSheetEmpty": "这里还没有设定时间的安排",
    "arrangements.laterSheetEmpty": "这里还没有暂放的安排",
    "arrangements.itemCountUnit": "条",
    "arrangements.filterAll": "全部",
    "arrangements.filterTime": "时间",
    "arrangements.filterPeople": "相关人",
    "arrangements.viewList": "列表",
    "arrangements.viewCalendar": "日历",
    "arrangements.listSort": "列表排序",
    "arrangements.sortCreated": "创建",
    "arrangements.sortTime": "时间",
    "arrangements.prevMonth": "上个月",
    "arrangements.nextMonth": "下个月",
    "arrangements.weekSun": "日",
    "arrangements.weekMon": "一",
    "arrangements.weekTue": "二",
    "arrangements.weekWed": "三",
    "arrangements.weekThu": "四",
    "arrangements.weekFri": "五",
    "arrangements.weekSat": "六",
    "arrangements.todayLabel": "今天",
    "arrangements.dayFlow": "当天时空流",
    "arrangements.dayEmpty": "这一天还没有明确安排",
    "arrangements.undatedTitle": "未定时间",
    "arrangements.undatedEmpty": "暂无未定时间的安排",
    "arrangements.manualSource": "手动创建",
    "arrangements.noTime": "暂未设定时间",
    "arrangements.noPeople": "暂无相关人",
    "arrangements.noLocation": "暂无地点",
    "arrangements.statusLater": "以后再说",
    "arrangements.statusPending": "待安排",
    "arrangements.statusCompleted": "已完成",
    "arrangements.edit": "编辑",
    "arrangements.save": "保存",
    "arrangements.undo": "撤销",
    "arrangements.completedToast": "已完成",
    "arrangements.actionTitle": "安排操作",
    "arrangements.actionHint": "先轻轻放一放，也可以直接处理掉",
    "arrangements.closeActions": "关闭安排操作",
    "arrangements.actionLater": "以后再说",
    "arrangements.actionReschedule": "改个时间",
    "arrangements.markComplete": "标记完成",
    "arrangements.reminderKicker": "恰好想起",
    "arrangements.reminderToday": "你之前提到的“{title}”，今天还顺利吗？",
    "arrangements.reminderRecent": "你之前提到的“{title}”，最近还顺利吗？",
    "arrangements.reminderTomorrow": "明天的“{title}”，要不要顺手看一眼？",
    "arrangements.reminderView": "看看",
    "arrangements.reminderLater": "稍后",
    "arrangements.pin": "置顶",
    "arrangements.unpin": "取消",
    "arrangements.pinned": "置顶",
    "arrangements.notPinned": "未置顶",
    "arrangements.delete": "删除",
    "arrangements.openDetail": "查看安排详情",
    "arrangements.closeDetail": "关闭安排详情",
    "arrangements.detailTitle": "安排详情",
    "arrangements.detailStatus": "状态",
    "arrangements.detailPin": "置顶",
    "arrangements.detailSource": "来源",
    "arrangements.detailCreatedAt": "创建时间",
    "arrangements.closeCreate": "关闭新建安排",
    "arrangements.createTitle": "新建安排",
    "arrangements.fieldTitle": "安排内容",
    "arrangements.fieldTitlePlaceholder": "例如：后天去医院复查",
    "arrangements.fieldDate": "日期",
    "arrangements.fieldTime": "时间",
    "arrangements.fieldTimePlaceholder": "例如：明天 9:30 / 周五下午",
    "arrangements.fieldTimeKind": "时间类型",
    "arrangements.timeKind.none": "未定",
    "arrangements.timeKind.allDay": "全天",
    "arrangements.timeKind.time": "时刻",
    "arrangements.timeKind.timeRange": "时间段",
    "arrangements.timeKindAllDay": "全天",
    "arrangements.fieldStartTime": "开始",
    "arrangements.fieldEndTime": "结束",
    "arrangements.fieldPeople": "相关人",
    "arrangements.fieldPeoplePlaceholder": "例如：小林 / 爸爸",
    "arrangements.fieldLocation": "地点",
    "arrangements.fieldLocationPlaceholder": "例如：公司 / 市中心医院",
    "arrangements.fieldNote": "备注",
    "arrangements.fieldNotePlaceholder": "补充背景、提醒方式或需要带的东西",
    ...
    "settings.aiApi": "AI API 设置",
    "settings.aiApiConfigured": "已配置，用于后续安排识别",
    "settings.aiApiNotConfigured": "未配置，暂不启用 AI 识别",
    ...
    "aiApi.title": "AI API 设置",
    "aiApi.status": "配置状态",
    "aiApi.description": "该配置将用于后续“安排识别”。当前版本只保存到本机浏览器，不会发起真实 AI 请求。",
    "aiApi.configured": "已配置",
    "aiApi.notConfigured": "未配置",
    "aiApi.baseUrl": "Base URL",
    "aiApi.baseUrlPlaceholder": "例如：https://api.openai.com/v1",
    "aiApi.apiKey": "API Key",
    "aiApi.apiKeyPlaceholder": "输入 API Key",
    "aiApi.apiKeyKeepPlaceholder": "留空则保留已保存的 Key",
    "aiApi.savedKey": "已保存 Key",
    "aiApi.model": "Model",
    "aiApi.modelPlaceholder": "例如：gpt-4o-mini",
    "aiApi.required": "请填写 Base URL、API Key 和 Model。",
    "aiApi.baseUrlInvalid": "Base URL 需要以 http:// 或 https:// 开头。",
    "aiApi.saved": "已保存 AI API 设置。",
    "aiApi.clear": "清除配置",
    "aiApi.clearConfirm": "再次点击确认清除",
    "aiApi.confirmClear": "确认清除",
    "aiApi.cleared": "已清除 AI API 设置。",
    "aiApi.save": "保存配置",
    "accent.green": "绿色",
    "accent.purple": "紫色",
    "accent.blue": "蓝色",
  ...
  "zh-TW": {
    ...
    "arrangements.drawerState": "內測",
    "arrangements.drawerPreview": "醫院、早餐、資料整理",
    "arrangements.statPending": "待安排",
    "arrangements.statToday": "今天",
    "arrangements.statTimed": "有時間",
    "arrangements.statLater": "以後再說",
    "arrangements.openPendingItems": "查看待安排事項",
    "arrangements.openTimedItems": "查看有時間事項",
    "arrangements.openLaterItems": "查看以後再說事項",
    "arrangements.closeStatItems": "關閉事項列表",
    "arrangements.laterSheetTitle": "以後再說",
    "arrangements.pendingSheetEmpty": "這裡還沒有待安排事項",
    "arrangements.timedSheetEmpty": "這裡還沒有設定時間的安排",
    "arrangements.laterSheetEmpty": "這裡還沒有暫放的安排",
    "arrangements.itemCountUnit": "條",
    "arrangements.filterAll": "全部",
    "arrangements.filterTime": "時間",
    "arrangements.filterPeople": "相關人",
    "arrangements.viewList": "列表",
    "arrangements.viewCalendar": "日曆",
    "arrangements.listSort": "列表排序",
    "arrangements.sortCreated": "建立",
    "arrangements.sortTime": "時間",
    "arrangements.prevMonth": "上個月",
    "arrangements.nextMonth": "下個月",
    "arrangements.weekSun": "日",
    "arrangements.weekMon": "一",
    "arrangements.weekTue": "二",
    "arrangements.weekWed": "三",
    ...
    "arrangements.weekSat": "六",
    "arrangements.todayLabel": "今天",
    "arrangements.dayFlow": "當天時空流",
    "arrangements.dayEmpty": "這一天還沒有明確安排",
    "arrangements.undatedTitle": "未定時間",
    "arrangements.undatedEmpty": "暫無未定時間的安排",
    "arrangements.manualSource": "手動建立",
    "arrangements.noTime": "暫未設定時間",
    "arrangements.noPeople": "暫無相關人",
    "arrangements.noLocation": "暫無地點",
    "arrangements.statusLater": "以後再說",
    "arrangements.statusPending": "待安排",
    "arrangements.statusCompleted": "已完成",
    "arrangements.edit": "編輯",
    "arrangements.save": "儲存",
    "arrangements.undo": "復原",
    "arrangements.completedToast": "已完成",
    "arrangements.actionTitle": "安排操作",
    "arrangements.actionHint": "先輕輕放一放，也可以直接處理掉",
    "arrangements.closeActions": "關閉安排操作",
    "arrangements.actionLater": "以後再說",
    "arrangements.actionReschedule": "改個時間",
    "arrangements.markComplete": "標記完成",
    "arrangements.reminderKicker": "剛好想起",
    "arrangements.reminderToday": "你之前提到的「{title}」，今天還順利嗎？",
    "arrangements.reminderRecent": "你之前提到的「{title}」，最近還順利嗎？",
    "arrangements.reminderTomorrow": "明天的「{title}」，要不要順手看一眼？",
    "arrangements.reminderView": "看看",
    "arrangements.reminderLater": "稍後",
    "arrangements.pin": "置頂",
    "arrangements.unpin": "取消",
    "arrangements.pinned": "置頂",
    "arrangements.notPinned": "未置頂",
    "arrangements.delete": "刪除",
    "arrangements.openDetail": "查看安排詳情",
    "arrangements.closeDetail": "關閉安排詳情",
    "arrangements.detailTitle": "安排詳情",
    "arrangements.detailStatus": "狀態",
    "arrangements.detailPin": "置頂",
    "arrangements.detailSource": "來源",
    "arrangements.detailCreatedAt": "建立時間",
    "arrangements.closeCreate": "關閉新增安排",
    "arrangements.createTitle": "新增安排",
    "arrangements.fieldTitle": "安排內容",
    "arrangements.fieldTitlePlaceholder": "例如：後天去醫院複查",
    "arrangements.fieldDate": "日期",
    "arrangements.fieldTime": "時間",
    "arrangements.fieldTimePlaceholder": "例如：明天 9:30 / 週五下午",
    "arrangements.fieldTimeKind": "時間類型",
    "arrangements.timeKind.none": "未定",
    "arrangements.timeKind.allDay": "全天",
    "arrangements.timeKind.time": "時刻",
    "arrangements.timeKind.timeRange": "時間段",
    "arrangements.timeKindAllDay": "全天",
    "arrangements.fieldStartTime": "開始",
    "arrangements.fieldEndTime": "結束",
    "arrangements.fieldPeople": "相關人",
    "arrangements.fieldPeoplePlaceholder": "例如：小林 / 爸爸",
    "arrangements.fieldLocation": "地點",
    "arrangements.fieldLocationPlaceholder": "例如：公司 / 市中心醫院",
    "arrangements.fieldNote": "備註",
    "arrangements.fieldNotePlaceholder": "補充背景、提醒方式或需要帶的東西",
    "homeMessagePreview.label": "新訊息",
    "settings.title": "設定",
    "settings.appearance": "外觀樣式設定",
    "settings.appearanceDesc": "主題、強調色與應用圖示",
    "settings.aiApi": "AI API 設定",
    "settings.aiApiConfigured": "已設定，用於後續安排識別",
    "settings.aiApiNotConfigured": "未設定，暫不啟用 AI 識別",
    ...
    "aiApi.title": "AI API 設定",
    "aiApi.status": "設定狀態",
    "aiApi.description": "該設定將用於後續「安排識別」。目前版本只保存到本機瀏覽器，不會發起真實 AI 請求。",
    "aiApi.configured": "已設定",
    "aiApi.notConfigured": "未設定",
    "aiApi.baseUrl": "Base URL",
    "aiApi.baseUrlPlaceholder": "例如：https://api.openai.com/v1",
    "aiApi.apiKey": "API Key",
    "aiApi.apiKeyPlaceholder": "輸入 API Key",
    "aiApi.apiKeyKeepPlaceholder": "留空則保留已保存的 Key",
    "aiApi.savedKey": "已保存 Key",
    "aiApi.model": "Model",
    "aiApi.modelPlaceholder": "例如：gpt-4o-mini",
    "aiApi.required": "請填寫 Base URL、API Key 和 Model。",
    "aiApi.baseUrlInvalid": "Base URL 需要以 http:// 或 https:// 開頭。",
    "aiApi.saved": "已保存 AI API 設定。",
    "aiApi.clear": "清除設定",
    "aiApi.clearConfirm": "再次點擊確認清除",
    "aiApi.confirmClear": "確認清除",
    "aiApi.cleared": "已清除 AI API 設定。",
    "aiApi.save": "保存設定",
    "common.back": "返回",
    "common.done": "完成",
    "common.selected": "已選擇",
  ...
  "en-US": {
    ...
    "arrangements.add": "New plan",
    "arrangements.drawerState": "Beta",
    "arrangements.drawerPreview": "Hospital, breakfast, documents",
    "arrangements.statPending": "Pending",
    "arrangements.statToday": "Today",
    "arrangements.statTimed": "Timed",
    "arrangements.statLater": "Later",
    "arrangements.openPendingItems": "View pending items",
    "arrangements.openTimedItems": "View timed items",
    "arrangements.openLaterItems": "View later items",
    "arrangements.closeStatItems": "Close item list",
    "arrangements.laterSheetTitle": "Later",
    "arrangements.pendingSheetEmpty": "No pending arrangements yet.",
    "arrangements.timedSheetEmpty": "No timed arrangements yet.",
    "arrangements.laterSheetEmpty": "No parked arrangements yet.",
    "arrangements.itemCountUnit": "items",
    "arrangements.filterAll": "All",
    "arrangements.filterTime": "Time",
    "arrangements.filterPeople": "People",
    "arrangements.viewList": "List",
    "arrangements.viewCalendar": "Calendar",
    "arrangements.listSort": "List sort",
    "arrangements.sortCreated": "Created",
    "arrangements.sortTime": "Time",
    "arrangements.prevMonth": "Previous month",
    "arrangements.nextMonth": "Next month",
    "arrangements.weekSun": "Sun",
    "arrangements.weekMon": "Mon",
    "arrangements.weekTue": "Tue",
    "arrangements.weekWed": "Wed",
    "arrangements.weekThu": "Thu",
    "arrangements.weekFri": "Fri",
    "arrangements.weekSat": "Sat",
    "arrangements.todayLabel": "Today",
    "arrangements.dayFlow": "Day timeline",
    "arrangements.dayEmpty": "No dated plans for this day",
    "arrangements.undatedTitle": "No date set",
    "arrangements.undatedEmpty": "No undated plans",
    "arrangements.manualSource": "Created manually",
    "arrangements.noTime": "No time set",
    "arrangements.noPeople": "No people set",
    "arrangements.noLocation": "No location set",
    ...
    "arrangements.save": "Save",
    "arrangements.undo": "Undo",
    "arrangements.completedToast": "Completed",
    "arrangements.actionTitle": "Plan actions",
    "arrangements.actionHint": "Set it aside gently, or take care of it now.",
    "arrangements.closeActions": "Close plan actions",
    "arrangements.actionLater": "Later",
    "arrangements.actionReschedule": "Change time",
    "arrangements.markComplete": "Mark complete",
    "arrangements.reminderKicker": "Just surfaced",
    "arrangements.reminderToday": "That “{title}” plan you mentioned is around today. Is it going okay?",
    "arrangements.reminderRecent": "That “{title}” plan you mentioned recently, how is it going?",
    "arrangements.reminderTomorrow": "That “{title}” plan is coming up tomorrow. Want to take a quick look?",
    "arrangements.reminderView": "Take a look",
    "arrangements.reminderLater": "Later",
    "arrangements.pin": "Pin",
    "arrangements.unpin": "Unpin",
    "arrangements.pinned": "Pinned",
    "arrangements.notPinned": "Not pinned",
    "arrangements.delete": "Delete",
    "arrangements.openDetail": "Open plan details",
    "arrangements.closeDetail": "Close plan details",
    "arrangements.detailTitle": "Plan details",
    "arrangements.detailStatus": "Status",
    "arrangements.detailPin": "Pin",
    "arrangements.detailSource": "Source",
    "arrangements.detailCreatedAt": "Created",
    "arrangements.closeCreate": "Close new plan",
    "arrangements.createTitle": "New plan",
    "arrangements.fieldTitle": "Plan",
    "arrangements.fieldTitlePlaceholder": "Example: hospital follow-up the day after tomorrow",
    "arrangements.fieldDate": "Date",
    "arrangements.fieldTime": "Time",
    "arrangements.fieldTimePlaceholder": "Example: tomorrow 9:30 / Friday afternoon",
    "arrangements.fieldTimeKind": "Time type",
    "arrangements.timeKind.none": "Unset",
    "arrangements.timeKind.allDay": "All day",
    "arrangements.timeKind.time": "Time",
    "arrangements.timeKind.timeRange": "Range",
    "arrangements.timeKindAllDay": "All day",
    "arrangements.fieldStartTime": "Start",
    "arrangements.fieldEndTime": "End",
    "arrangements.fieldPeople": "People",
    "arrangements.fieldPeoplePlaceholder": "Example: Lin / dad",
    "arrangements.fieldLocation": "Location",
    "arrangements.fieldLocationPlaceholder": "Example: office / hospital",
    "arrangements.fieldNote": "Note",
    "arrangements.fieldNotePlaceholder": "Add background, reminders, or things to bring",
    ...
    "settings.aiApi": "AI API settings",
    "settings.aiApiConfigured": "Configured for future arrangement recognition",
    "settings.aiApiNotConfigured": "Not configured; AI recognition is off",
    ...
    "aiApi.title": "AI API settings",
    "aiApi.status": "Configuration status",
    "aiApi.description": "This configuration will be used by future arrangement recognition. This version only saves it in the current browser and does not send real AI requests.",
    "aiApi.configured": "Configured",
    "aiApi.notConfigured": "Not configured",
    "aiApi.baseUrl": "Base URL",
    "aiApi.baseUrlPlaceholder": "Example: https://api.openai.com/v1",
    "aiApi.apiKey": "API Key",
    "aiApi.apiKeyPlaceholder": "Enter API Key",
    "aiApi.apiKeyKeepPlaceholder": "Leave blank to keep the saved key",
    "aiApi.savedKey": "Saved key",
    "aiApi.model": "Model",
    "aiApi.modelPlaceholder": "Example: gpt-4o-mini",
    "aiApi.required": "Please fill in Base URL, API Key and Model.",
    "aiApi.baseUrlInvalid": "Base URL must start with http:// or https://.",
    "aiApi.saved": "AI API settings saved.",
    "aiApi.clear": "Clear settings",
    "aiApi.clearConfirm": "Tap again to confirm clearing",
    "aiApi.confirmClear": "Confirm clear",
    "aiApi.cleared": "AI API settings cleared.",
    "aiApi.save": "Save settings",
    "accent.green": "Green",
